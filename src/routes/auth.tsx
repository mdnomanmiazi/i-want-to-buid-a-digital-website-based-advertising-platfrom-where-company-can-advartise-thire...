    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-between bg-ink p-12 text-ink-foreground">
        ...
        <div>
          <h2 className="font-display text-4xl font-bold leading-tight">
            Get your brand in front of thousands of <span className="text-primary">deal-hungry shoppers</span>.
          </h2>
          <p className="mt-4 text-ink-foreground/70">Post your first offer in minutes. No hidden fees.</p>
        </div>
      ...
      <div className="flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="mt-1 text-muted-foreground">Sign in to manage your offers.</p>
          ...
          <Tabs defaultValue="signin">
            ...
            <TabsContent value="signup">
              <form onSubmit={onSignUp} className="space-y-4 pt-4">
                <div><Label htmlFor="company">Company / Brand name</Label><Input id="company" name="company" required /></div>
