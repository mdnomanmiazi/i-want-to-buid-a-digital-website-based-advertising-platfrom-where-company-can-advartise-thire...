...
export const Route = createFileRoute("/admin/status")({
  head: () => ({ meta: [{ title: "Current Status — Admin" }] }),
  component: () => (
    <div className="min-h-screen">
      ...
      <div className="container-page py-20">
        <div className="mx-auto max-w-2xl rounded-3xl border border-border bg-card p-10 text-center">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold tracking-tight">Current Status</h1>
          <p className="mt-3 text-muted-foreground">Total ads running by category. Rolling out in Phase 4.</p>
